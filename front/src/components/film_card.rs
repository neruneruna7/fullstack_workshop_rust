...
pub fn FilmCard<'a>(
    ...
    cx.render(rsx! {
        li {
            class: "film-card md:basis-1/4 p-4 rounded box-border bg-neutral-50 drop-shadow-md transition-all ease-in-out hover:drop-shadow-xl flex-col flex justify-start items-stretch animate-fade animate-duration-500 animate-ease-in-out animate-normal animate-fill-both",
            header {
                img {
